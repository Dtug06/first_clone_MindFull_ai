...
const categories = [
  ...
  { name: 'Stress Management', count: 2 },
  { name: 'Sleep Hygiene', count: 1 },
  { name: 'Journaling', count: 1 },
  { name: 'CBT-based exercises', count: 2 },
  { name: 'DBT-based exercises', count: 1 },
  { name: 'Communication Skills', count: 1 },
];
    ...
    <div className="min-h-screen bg-background pb-24 lg:pb-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        >
          ...
          <p className="text-textMuted">Curated resources to support your mental wellness journey.</p>
        </motion.div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-medium text-textMain">{article.title}</h3>
        ...
        {filteredArticles.length === 0 && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
          >
            <p className="text-textMuted">No articles found for your search.</p>
          </motion.div>
        )}
      </div>
    </div>
