...
CREATE TABLE IF NOT EXISTS consent_events (
    ...
    event_order    BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS consent_events_event_order_uq ON consent_events (event_order);
